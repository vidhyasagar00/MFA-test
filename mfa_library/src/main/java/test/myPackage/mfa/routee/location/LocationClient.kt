...
import test.myPackage.mfa.routee.database.AppDatabase
import test.myPackage.mfa.routee.database.DatabaseHelperImpl
...
import test.myPackage.mfa.routee.utils.PermissionReqCreator
...
//                progress.dismiss()
    ...
    fun getLatestLocation() {
        extrasIntent?.putExtra("authTypes", extrasIntent.getStringExtra("authTypes")?.replace(
